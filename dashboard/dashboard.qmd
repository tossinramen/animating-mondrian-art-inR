...
-   Mondrian's Art **Our project is linked here:** [GitHub
    Repository](https://github.com/vizdata-s24/project-2-plot_twisters)
...
![](images/Mondrian 1.jpg){fig-alt="An abstract painting by Piet Mondrian with black lines forming a grid of rectangles and squares. The shapes are filled with primary colors: red, blue, and yellow, along with white spaces. The composition is balanced yet asymmetrical."
width="5in"}
...
![](images/Mondrian 2.jpg){width="5in"}
...
![](images/Mondrian 3.jpg){width="5in"}
