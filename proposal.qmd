...
One of our major goals for this project is to offer a new perspective on interpreting art with data visualization using ggplot2. By animating the transformation of one piece into another, we hope to drastically increase our skills in the visualization field of R while also visualizing Mondrian's artistic journey and expertise through animating expanding boxes and changing positions. We hope this process will help us uncover any patterns in Mondrian's work and help us better understand the thought process Mondrian had while creating his work.
