...
.image-container img {
  width: 2.5in; /* Adjust the width of each image */
...
<div class="image-container">
  <img src="images/Mondrian%201.jpg" alt="Mondrian 1">
  <img src="images/Mondrian%202.jpg" alt="Mondrian 2">
  <img src="images/Mondrian%203.jpg" alt="Mondrian 3">
</div>
...
Our project, "Mondrian Art" is an adventure into the
transformation of Piet Mondrian's art using `ggplot2` and `gganimate`
within R. Piet Mondrian, a pioneer in the
development of modern abstract art and a major proponent of the Dutch
abstract art movement De Stijl, used basic shapes and 
forms—primarily rectangles, squares, and lines—and a restricted palette
of primary colors, black, and white. His works give us a basic sandbox to play 
with, which underscores one of our project's goal to animate
...
interacting with abstract compositions. Another goal of ours is to be able to 
replicate, at least in part, his idea of natural imperfections, by adding our
own touches to his works.

**Historical Context and Motivation**\

Piet Mondrian's art was influenced by his desire to express
the spiritual through the abstract; he had a love for the natural world and 
life around him. Initially inspired by the landscape the many cities he lived in,
he noted the interplay of lines and colors in nature. His work progressively 
embraced the abstract, eventually evolving into the lines and squares we see.
The influence of Post-Impressionists and his exposure to American jazz
...
elements. We aim to demystify the nature of his paintings, using
animations to visualize the dynamic motions potentially envisioned
in Mondrian's creative mind. Mondrian's works, while seemingly perfect, often
contain an accidentally crooked line, or squares the do not intersect perfectly.
Some of his critics (and even students) would go on to try to correct this in 
their own paintings, but this human imperfection that Mondrian was so fond of is
one of the driving forces behind some of our technical applications.
...
changes throughout Mondrian's art to life. This involved  altering
line segments and color fields to morph one painting into another,
highlighting the common boxes and lines between the three paintings. We then 
created a shiny app that allows users to interact with Mondrian's work, adding
their own human touch. Note, all the lines someone can add are placed randomly,
so two people will never have the same artwork. 
...
different forms. Through this endeavor, we observed
...
Through the app, we emphasize the innate imperfections we have. While our
animations may contain pixel-perfect straight lines, by adding our human touch,
we add some degree of imperfections back into Mondrian's art. 
This tool empowers users to alter the number of lines, modify the color
...
"Mondrian Art" combines a historical art piece with modern
technological tools, showcasing how digital media can offer new
insights into a rather abstract art forms. This project not only enhanced
...
static images into one animation, our viewers to engage with
Mondrian’s work in a new manner, thus broadening the
accessibility and understanding of his art through the lens of data
visualization. Our app then allows viewers to engage directly with some of 
his pieces. They get to experience some of the imperfections Mondrian was
so fond of.

In conclusion, "Mondrian Art" is a tool connecting the past with the present.
Art lovers and technologists alike explore the beauty and complexity
of Mondrian’s works through modern visualization techniques. Through
this project, we have laid a foundation for future explorations into the
digital representation of abstract art, and we hope to inspire others to
